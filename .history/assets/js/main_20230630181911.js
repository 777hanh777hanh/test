...
btnElement.addEventListener('click', () => {
    const url =
        urlElement.value |
        'https://sg-hkrpg-api.hoyoverse.com/common/apicdkey/api/webExchangeCdkey?t=1688100564621&lang=vi&game_biz=hkrpg_global&uid=800271421&region=prod_official_asia&cdkey=STARRAILGIFT';
    console.log(url);
